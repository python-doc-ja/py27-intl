...
.. class:: RawConfigParser([defaults])
   ...
   into the dictionary of intrinsic defaults.  This class does not support the
   magical interpolation behavior.
...
.. method:: XXX Class.defaults()

   Return a dictionary containing the instance-wide defaults.


.. method:: XXX Class.sections()

   Return a list of the sections available; ``DEFAULT`` is not included in the
   list.


.. method:: XXX Class.add_section(section)
...
.. method:: XXX Class.has_section(section)

   Indicates whether the named section is present in the configuration. The
   ``DEFAULT`` section is not acknowledged.


.. method:: XXX Class.options(section)

   Returns a list of options available in the specified *section*.


.. method:: XXX Class.has_option(section, option)
...
.. method:: XXX Class.read(filenames)
...
.. method:: XXX Class.readfp(fp[, filename])
...
.. method:: XXX Class.items(section)

   Return a list of ``(name, value)`` pairs for each option in the given *section*.


.. method:: XXX Class.set(section, option, value)
...
.. method:: XXX Class.write(fileobject)
...
.. method:: XXX Class.remove_option(section, option)
...
.. method:: XXX Class.get(section, option[, raw[, vars]])
...
.. method:: XXX Class.items(section[, raw[, vars]])
