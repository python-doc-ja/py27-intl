...
.. method:: XXX Class.find(string[, start])
...
.. method:: XXX Class.flush([offset, size])
...
.. method:: XXX Class.move(dest, src, count)
...
.. method:: XXX Class.resize(newsize)
...
.. method:: XXX Class.write_byte(byte)
