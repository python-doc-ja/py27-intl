...
.. class:: Telnet([host[, port]])
   ...
   will be established before the constructor returns.
...
.. method:: XXX Class.read_until(expected[, timeout])
...
.. method:: XXX Class.read_very_lazy()
...
.. method:: XXX Class.set_debuglevel(debuglevel)
...
.. method:: XXX Class.interact()

   Interaction function, emulates a very dumb Telnet client.


.. method:: XXX Class.mt_interact()

   Multithreaded version of :meth:`interact`.


.. method:: XXX Class.expect(list[, timeout])
...
.. method:: XXX Class.set_option_negotiation_callback(callback)
