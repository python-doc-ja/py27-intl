...
.. method:: XXX Class.launchurl(url[, hint])
...
.. method:: XXX Class.parseurl(data[, start[, end[, hint]]])
...
.. method:: XXX Class.maptypecreator(type, creator[, filename])
...
.. method:: XXX Class.settypecreator(file)
