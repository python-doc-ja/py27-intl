...
Internal types
   ...
   Code objects
      ...
      which it was defined), while a code object contains no context;  also the
...
.. method:: object.__lt__(self, other)
   ...
   ``x.__ge__(y)``. These methods can return any value, but if the comparison
   ...
   Arguments to rich comparison methods are never coerced.  A rich comparison
...
:meth:`pop`, :meth:`popitem`,                 :meth:`copy`, and :meth:`update`
