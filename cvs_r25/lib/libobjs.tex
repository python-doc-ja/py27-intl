...
\chapter{組み込みオブジェクト \label{builtin}}
...
することができます。
組み込み型については参照しやすいようにここで説明されています。\footnote{
...
の余地はないでしょう。) \footnote{訳者註: HTML版では、変換の過程で
表の区切り情報が消えてしまっているので、PS版やPDF版をごらんください。}
オペレータの優先順位についての詳細は\citetitle[../ref/ref.html]{Python
Reference Manual}の5章をごらんください。
