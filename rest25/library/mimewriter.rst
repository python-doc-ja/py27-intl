...
.. method:: XXX Class.addheader(key, value[, prefix])
...
.. method:: XXX Class.startbody(ctype[, plist[, prefix]])
...
.. method:: XXX Class.startmultipartbody(subtype[, boundary[, plist[, prefix]]])
