...
.. method:: XXX Class.cmdloop([intro])
...
.. method:: XXX Class.default(line)

   Method called on an input line when the command prefix is not recognized. If
   this method is not overridden, it prints an error message and returns.


.. method:: XXX Class.completedefault(text, line, begidx, endidx)

   Method called to complete an input line when no command-specific
   :meth:`complete_\*` method is available.  By default, it returns an empty list.


.. method:: XXX Class.precmd(line)
...
.. method:: XXX Class.postcmd(stop, line)
...
.. attribute:: XXX Class.prompt

   The prompt issued to solicit input.


.. attribute:: XXX Class.identchars

   The string of characters accepted for the command prefix.


.. attribute:: XXX Class.lastcmd

   The last nonempty command prefix seen.


.. attribute:: XXX Class.intro

   A string to issue as an intro or banner.  May be overridden by giving the
   :meth:`cmdloop` method an argument.


.. attribute:: XXX Class.doc_header

   The header to issue if the help output has a section for documented commands.


.. attribute:: XXX Class.misc_header
...
.. attribute:: XXX Class.undoc_header
