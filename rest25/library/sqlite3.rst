...
.. function:: connect(database[, timeout, isolation_level, detect_types, factory])
   ...
   you want to use other types, like you have to add support for them yourself. The
...
.. function:: complete_statement(sql)
   ...
   Returns :const:`True` if the string *sql* one or more complete SQL statements
...
.. method:: XXX Class.cursor([cursorClass])
...
.. method:: XXX Class.executemany(sql, [parameters])
...
.. method:: XXX Class.create_function(name, num_params, func)
...
.. method:: XXX Class.create_aggregate(name, num_params, aggregate_class)
...
.. method:: XXX Class.create_collation(name, callable)
...
.. method:: XXX Class.set_authorizer(authorizer_callback)
...
.. attribute:: XXX Class.text_factory
...
.. attribute:: XXX Class.total_changes
...
.. method:: XXX Class.executemany(sql, seq_of_parameters)
