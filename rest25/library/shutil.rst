...
.. function:: copystat(src, dst)
   ...
   Copy the permission bits, last access time, and last modification time from
   *src* to *dst*.  The file contents, owner, and group are unaffected.  *src* and
...
.. function:: rmtree(path[, ignore_errors[, onerror]])
   ...
   Delete an entire directory tree. If *ignore_errors* is true, errors resulting
