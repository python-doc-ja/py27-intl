...
.. method:: XXX Class.login([user[, passwd[, acct]]])
...
.. method:: XXX Class.retrbinary(command, callback[, maxblocksize[, rest]])
...
.. method:: XXX Class.retrlines(command[, callback])
...
.. method:: XXX Class.set_pasv(boolean)
...
.. method:: XXX Class.storbinary(command, file[, blocksize])
...
.. method:: XXX Class.ntransfercmd(cmd[, rest])
...
.. method:: XXX Class.nlst(argument[, ...])
...
.. method:: XXX Class.rename(fromname, toname)

   Rename file *fromname* on the server to *toname*.


.. method:: XXX Class.delete(filename)
...
.. method:: XXX Class.cwd(pathname)

   Set the current directory on the server.


.. method:: XXX Class.mkd(pathname)

   Create a new directory on the server.


.. method:: XXX Class.pwd()

   Return the pathname of the current directory on the server.


.. method:: XXX Class.rmd(dirname)

   Remove the directory named *dirname* on the server.


.. method:: XXX Class.size(filename)
